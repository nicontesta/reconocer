...
- [Problemas y Consideraciones con Markdown, LaTeX, MathML y Plataformas Web](#problemas-y-consideraciones-con-markdown-latex-mathml-y-plataformas-web)
- [Ejemplos](#ejemplos)
  - [📄 1. Ejemplos de Markdown con LaTeX](#1-ejemplos-de-markdown-con-latex)
  - [📘 2. Ejemplo: Markdown a EPUB con Pandoc y WebTeX](#2-ejemplo-markdown-a-epub-con-pandoc-y-webtex)
  - [🌐 3. Ejemplo: HTML con MathML + YAML para GitHub Pages](#3-ejemplo-html-con-mathml-yaml-para-github-pages)
  - [🧪 4. Ejemplo: Conversión .md → .html con MathML usando Pandoc](#4-ejemplo-conversion-codemdcode-codehtmlcode-con-mathml-usando-pandoc)
  - [❌ 5. Errores comunes al renderizar](#5-errores-comunes-al-renderizar)
- [⚙️ Automatización: Scripts para convertir .md con fórmulas LaTeX](#automatizacion-scripts-para-convertir-codemdcode-con-formulas-latex)
  - [⚙️ 1. Script PowerShell para Windows](#1-script-powershell-para-windows)
  - [⚙️ 2. Script Bash para Linux/macOS](#2-script-bash-para-linuxmacos)
  - [🧩 Opcional: Convertir todos los .md de una carpeta (Bash)](#opcional-convertir-todos-los-codemdcode-de-una-carpeta-bash)
  - [📝 Notas:](#notas)
  - [🎨 Ajustes visuales y CSS para MathML en la web](#ajustes-visuales-y-css-para-mathml-en-la-web)
  - [✅ CSS base recomendado para MathML](#css-base-recomendado-para-mathml)
  - [📌 Ejemplo de uso en un HTML con fórmula](#ejemplo-de-uso-en-un-html-con-formula)
  - [🔍 Sugerencias adicionales](#sugerencias-adicionales)
  - [❌ Problemas comunes resueltos con este CSS](#problemas-comunes-resueltos-con-este-css)
- [🌐 Despliegue de sitios en GitHub Pages y Netlify](#despliegue-de-sitios-en-github-pages-y-netlify)
- [🐻 Exportar desde Bearblog → HTML / Markdown / EPUB](#exportar-desde-bearblog-html-markdown-epub)
- [🧭 Navegación básica para sitio web estático](#navegacion-basica-para-sitio-web-estatico)
- [📄 Usar plantillas en Pandoc para menú común en HTML](#usar-plantillas-en-pandoc-para-menu-comun-en-html)
- [🖼️ Optimización de imágenes para sitio web estático](#optimizacion-de-imagenes-para-sitio-web-estatico)
- [📈 Uso de variables y metadatos YAML para SEO en Markdown/HTML](#uso-de-variables-y-metadatos-yaml-para-seo-en-markdownhtml)
- [🚀 Desplegar sitio web con SEO optimizado en Netlify y GitHub Pages](#desplegar-sitio-web-con-seo-optimizado-en-netlify-y-github-pages)
- [🤖 Automatización del workflow con GitHub Actions para build y deploy](#automatizacion-del-workflow-con-github-actions-para-build-y-deploy)
- [🚀 Automatizar despliegue a Netlify desde GitHub Actions](#automatizar-despliegue-a-netlify-desde-github-actions)
- [🛠 Uso de \_redirects y \_headers en Netlify](#uso-de-code_redirectscode-y-code_headerscode-en-netlify)
- [🌐 Favicons, Open Graph y metaetiquetas sociales](#favicons-open-graph-y-metaetiquetas-sociales)
- [🗺️ Sitemap y robots.txt para mejorar indexación en buscadores](#sitemap-y-robotstxt-para-mejorar-indexacion-en-buscadores)
- [♿ Accesibilidad web básica (A11y) para sitios estáticos](#accesibilidad-web-basica-a11y-para-sitios-estaticos)
- [⚡ Minificación y compresión para mejorar el rendimiento web](#minificacion-y-compresion-para-mejorar-el-rendimiento-web)
- [🔤 Fuentes locales vs. externas (Google Fonts): rendimiento y privacidad](#fuentes-locales-vs-externas-google-fonts-rendimiento-y-privacidad)
- [🌙 Modo oscuro (Dark Mode) con CSS](#modo-oscuro-dark-mode-con-css)
- [🔁 Generar HTML, EPUB y PDF desde un mismo archivo .md usando Pandoc](#generar-html-epub-y-pdf-desde-un-mismo-archivo-codemdcode-usando-pandoc)
- [Manejo de imágenes y rutas relativas en Markdown para múltiples formatos](#manejo-de-imagenes-y-rutas-relativas-en-markdown-para-multiples-formatos)
- [📋 Gestión de metadatos en YAML front matter para múltiples formatos](#gestion-de-metadatos-en-yaml-front-matter-para-multiples-formatos)
- [🧩 Plantillas personalizadas en Pandoc para HTML, EPUB y PDF](#plantillas-personalizadas-en-pandoc-para-html-epub-y-pdf)
